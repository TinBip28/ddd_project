-- 1. Create Ticket Database and Tables
CREATE DATABASE IF NOT EXISTS `vetautet_ticket`
...
-- Insert mock data for Ticket Service
...
-- 2. Create Order Database and Tables
CREATE DATABASE IF NOT EXISTS `vetautet_order`
    DEFAULT CHARSET = utf8mb4
    COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ticket_order_202502` (
    ...
    ticket_id INT(8) NOT NULL COMMENT 'ticketId',
    quantity INT(8) NOT NULL COMMENT 'quantity',
    order_status INT(2) NOT NULL DEFAULT 0 COMMENT '0: PENDING, 1: SUCCESS, 2: CANCELLED',
...
-- Insert mock data for Order Service
INSERT INTO `ticket_order_202502` (order_number, user_id, ticket_id, quantity, order_status, total_amount, terminal_id, order_date, order_notes)
VALUES ('ORD2025020001', 1001, 4, 4, 0, 5.600, 'POS001', '2025-02-28 10:00:00', 'Family trip');

INSERT INTO `ticket_order_details_202502` (ticket_item_id, order_number, passenger_name, passenger_id, departure_station, arrival_station, departure_time, seat_class, seat_number, ticket_price)
VALUES
...
-- 3. Create Payment Database and Tables
CREATE DATABASE IF NOT EXISTS `vetautet_payment`
    DEFAULT CHARSET = utf8mb4
    COLLATE = utf8mb4_unicode_ci;

USE `vetautet_payment`;
...
CREATE TABLE IF NOT EXISTS `payment_transaction` (
   ...
   `amount` DECIMAL(16,3) NOT NULL COMMENT 'Số tiền thanh toán',
